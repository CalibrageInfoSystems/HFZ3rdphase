...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> changePassword() async {
    if (_formKey.currentState!.validate()) {
      ...
      Map<String, dynamic> requestBody = {"id": id.toInt(), "oldPassword": "$currentpassword", "newPassword": "$newpassword", "confirmPassword": "$confirmnewpassword"};
      ...
      if (response.statusCode == 200) {
        ...
        if (isSuccess) {
          ...
          CommonUtils.showCustomToastMessageLongbottom('$statusMessage',  context, 1, 4);
        }
      } else {
  ...
  Future<void> onConfirmLogout(BuildContext context) async {
    ...
    //CommonUtils.showCustomToastMessageLong("Password Changed Successfully Please Login Again", context, 0, 3);
    CommonUtils.showCustomToastMessageLongbottom('Password Changed Successfully Please Login Again ',  context, 0, 4);
