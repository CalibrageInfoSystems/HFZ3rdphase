...
import 'package:hairfixingzone/Agentbooking_Screen.dart';
...
class Branchesforagent_screen extends StatefulWidget {
  final int userId;

  const Branchesforagent_screen({super.key, required this.userId});

  @override
  _BranchesscreenState createState() => _BranchesscreenState();
}

class _BranchesscreenState extends State<Branchesforagent_screen> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
          onTap: () {
            print('branchaddress${branchnames.address}');
            print('branchname${branchnames.name}');
            print('branchId${branchnames.id!}');
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => AgentbookingScreen(branchId: branchnames.id!, branchname: branchnames.name, branchaddress: branchnames.address, AgentId: userId, branchImage: branchnames.imageName!,
